...
#
# 用途：
#   �?workers/orchestrator-worker.ts 及其依赖打包为独立可运行产物�?
#   �?Docker 单独部署（docker-compose �?worker service）�?
#
# 产物�?
...
#
# 验证�?
#   node dist-workers/orchestrator-worker.js   # 启动后连�?Redis，消�?generation:v2
#
# 注意�?
#   - 使用 tsup 打包（已�?devDependencies�?
#   - 不升级任何依赖版�?
# ========================================
